...
Lifecycle mutation follows that distinction: historical-viewable editions may
still be favorited, but only published editions accept new or reconfigured
subscriptions. Owners can always remove either existing relation, even after
the target becomes offline.
