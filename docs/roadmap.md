...
| P2 | Recommendation and governance | Add explainable recommendations and operational control. | Rule-based recommendations, recommendation reasons, explanation consistency with赛事 tags and value-basis notes, configurable dictionaries/rules, audit logs, user management, and basic statistics. |
